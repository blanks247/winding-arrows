...
const App = {
  ...
  bindEvents() {
    ...
    document.getElementById('btn-next-level').addEventListener('click', () => {
      ...
      if (nextId <= 10) {
        ...
        alert("🎉 INCREDIBLE! You have unlocked and escaped all 10 polyline sectors!");
        this.showScreen('level-select-screen');
        this.renderLevelSelect();
      }
    });
  ...
  renderLevelSelect() {
    ...
    // Winding coordinates for Candy Crush Saga Map (connecting 10 levels)
    const coords = [
      { x: 180, y: 700 }, // Level 1 (bottom center)
      { x: 90,  y: 630 }, // Level 2
      { x: 126, y: 560 }, // Level 3
      { x: 270, y: 490 }, // Level 4
      { x: 180, y: 420 }, // Level 5
